...
const controlAddBookmark = function() {
    ...
    else _modelJs.state.recipe.bookmarked = true;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","regenerator-runtime/runtime":"f6ot0","core-js/modules/web.immediate.js":"bzsBv","./model.js":"3QBkH","./views/recipeView.js":"3wx5k","./views/searchview.js":"3up1j","./views/resultsView.js":"kBQ4r","./views/bookmarksView.js":"1qGeA","./views/paginationView.js":"7NIiB","./views/addRecipeView.js":"8AWnP","./config.js":"2hPh4"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
const loadRecipe = async function(id) {
    try {
        ...
        //temp error handling
        console.log(`${err1}\u{1F4A5}\u{1F4A5}`);
        throw err1;
    }
};
...
const updateServings = function(newServings) {
    state.recipe.ingredients.forEach((ing)=>{
        ...
        // newQuantity = (oldq * new servings) / olds
...
const KEY = '65daa208-f21d-446f-aa3c-3ace125de60e';
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    addHandlerUpdateServings(handler) {
        this._parentElement.addEventListener('click', function(e) {
            const btn1 = e.target.closest('.btn--update-servings');
            if (!btn1) return;
            console.log(btn1);
            const { updateTo } = +btn1.dataset.updateTo;
            if (+updateTo > 0) handler(+updateTo);
        });
    }
    addHandlerAddBookmark(handler) {
        this._parentElement.addEventListener('click', function(e) {
            const btm = e.target.closest('.btn--bookmark');
            if (!btn) return;
            handler();
        });
    }
    ...
    _generateMarkupIngredient(ing) {
        return `
            <li class="recipe__ingredient">
              ...
              <div class="recipe__quantity">${ing.quantity ? new (0, _fractyDefault.default)(ing.quantity).toString() : ''}</div>
...
class View {
    ...
    update(data) {
        ...
        newElements.forEach(newEl, (i)=>{
            ...
            if (!newEl.isEqualNode(curEl) && newEl.firstChild?.nodeValue.trim() !== '') curEl.textContent = newEl.textContent; //replaces everything
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","url:../../img/icons.svg":"fd0vu"}],"3up1j":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
},{"./view":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./previewView":"6tKHS","url:../../img/icons.svg":"fd0vu"}],"6tKHS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"2kjY2","url:../../img/icons.svg":"fd0vu","./previewView":"6tKHS","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7NIiB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"2kjY2","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8AWnP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
